...
// --- BASE DE DADOS LIMPA (APENAS NOME E CADASTRO CONFORME SOLICITADO) ---
const cleanDriverList = [
    ...
    { b: "Curitiba", c: "1501", n: "Alex Sandro Vasconcelos", t: "rodoviario" },
    ...
    { b: "Londrina", c: "00001", n: "Lucas de Paiva", t: "rodoviario" }, 
    ...
    { b: "Ponta Grossa", c: "00002", n: "Odilon Emanuel Tarum Borges", t: "rodoviario" }, 
    ...
    { b: "Fretamento Coamo", c: "21921", n: "Gilberto de Oliveira Santos", t: "fretamento" },
    ...
    { b: "Fretamento Unitá", c: "21753", n: "Eliezer Rodrigues", t: "fretamento" },
    ...
    { b: "Fretamento Unitá", c: "21693", n: "Adriano Soares Costa", t: "fretamento" },
    ...
    { b: "Fretamento Coopacol", c: "21766", n: "Ademir de Lima", t: "fretamento" },
    ...
    { b: "Fretamento Coopacol", c: "21699", n: "Edemilson Marcelo Posso", t: "fretamento" },
    { b: "Fretamento Coopacol", c: "21899", n: "Geisiel Lucas Martins", t: "fretamento" },
    { b: "Fretamento Coopacol", c: "21786", n: "Giliardi dos Santos Pessoto", t: "fretamento" },
    { b: "Fretamento Coopacol", c: "00003", n: "Marciano André Wecker", t: "fretamento" },
    ...
    { b: "Fretamento JBS", c: "1624", n: "Adão José Marcondes", t: "fretamento" },
    ...
    // RELATÓRIOS/DESLIGAMENTOS/DIVERSOS (Adicionados à Fretamento Genérico se aplicável ou retirados caso demitidos. Mantidos aqui para histórico base conforme tabela, limpos).
    { b: "Fretamento Geral", c: "21688", n: "Eliezer Rodrigues", t: "fretamento" },
    { b: "Fretamento Geral", c: "1673", n: "Joelson Alves", t: "fretamento" },
    { b: "Fretamento Geral", c: "1680", n: "Mayckon Diuliano Lopes", t: "fretamento" },
    { b: "Fretamento Geral", c: "21667", n: "Edcarlos de Souza", t: "fretamento" },
    { b: "Fretamento Geral", c: "21713", n: "Paulino Pereira de Oliveira", t: "fretamento" },
    { b: "Fretamento Geral", c: "1634", n: "Genilson Teixeira Souza", t: "fretamento" },
    { b: "Fretamento Geral", c: "21663", n: "Evanir Aparecido Lopes", t: "fretamento" },
    { b: "Fretamento Geral", c: "21701", n: "Antonio de Oliveira", t: "fretamento" },
    { b: "Fretamento Geral", c: "1647", n: "Vanilson de Souza Costa", t: "fretamento" },
    { b: "Fretamento Geral", c: "21368", n: "Vagner Leandro da Silva", t: "fretamento" },
    { b: "Fretamento Geral", c: "21689", n: "Flávio Pereira", t: "fretamento" },
    { b: "Fretamento Geral", c: "21620", n: "Fábio Luan Pachiski", t: "fretamento" },
    { b: "Fretamento Geral", c: "1649", n: "Paulo Firmino da Silva", t: "fretamento" },
    { b: "Fretamento Geral", c: "21444", n: "Marcos Cezar da Silva", t: "fretamento" },
    { b: "Fretamento Geral", c: "1646", n: "Valdemir Ferreira dos Santos", t: "fretamento" },
    { b: "Fretamento Geral", c: "1959", n: "Gilberto de Oliveira santos", t: "fretamento" },
    { b: "Fretamento Geral", c: "21790", n: "Elson Paes", t: "fretamento" },
    { b: "Fretamento Geral", c: "21666", n: "Arlindo Alberto Lima", t: "fretamento" },
    { b: "Fretamento Geral", c: "21814", n: "Deividy Junior Bazza Moggio", t: "fretamento" },
    { b: "Fretamento Geral", c: "19872", n: "Ademar Mendes", t: "fretamento" },
    { b: "Fretamento Geral", c: "21830", n: "Samuel Silva Santos", t: "fretamento" },
    { b: "Fretamento Geral", c: "21809", n: "Gilcima Alves Moreira", t: "fretamento" },
    { b: "Fretamento Geral", c: "21084", n: "Francisco de Souza Filho", t: "fretamento" },
    { b: "Fretamento Geral", c: "1956", n: "Neuderino Ferreira Ramos", t: "fretamento" },
    { b: "Fretamento Geral", c: "21829", n: "Lucas Freitas antunes", t: "fretamento" },
    { b: "Fretamento Geral", c: "21788", n: "Cristiano Peralta Andrez", t: "fretamento" },
    { b: "Fretamento Geral", c: "21715", n: "Denivaldo de Oliveira", t: "fretamento" },
    { b: "Fretamento Geral", c: "1627", n: "Afonso Ap. da Costa", t: "fretamento" },
    { b: "Fretamento Geral", c: "21831", n: "Matheus Santos de Lima", t: "fretamento" },
    { b: "Fretamento Geral", c: "1679", n: "Hugo Leandro Pereira", t: "fretamento" },
    { b: "Fretamento Geral", c: "21376", n: "Milton Goulart", t: "fretamento" },
    { b: "Fretamento Geral", c: "2092", n: "Odair José Gonsalves", t: "fretamento" },
    { b: "Fretamento Geral", c: "21595", n: "Adão Leandro de Lima", t: "fretamento" },
    { b: "Fretamento Geral", c: "2242", n: "Luana Pereira Martins", t: "fretamento" }
];
...
function initApp() {
    ...
    if (savedApprover) {
        ...
        // Seu nome pré-definido caso seja o primeiro acesso na máquina
    ...
    // CONEXÃO FIREBASE E ATUALIZAÇÃO DA BASE
    driversRef.once('value', (snapshot) => {
        // ATENÇÃO: Esta linha força a subida da base limpa para o Firebase. 
        // Eliminando quem não está na lista oficial.
        driversRef.set(cleanDriverList);
        driverList = cleanDriverList;
        sortDriverList();
        renderTable();
    });
...
function renderTable() {
    ...
    if (totalSector === 0) {
        container.innerHTML = `<div style="text-align:center; padding: 40px; color:#888;">Nenhum colaborador encontrado para o setor: <b>${currentSector === 'rodoviario' ? 'Rodoviário' : 'Fretamento'}</b>.</div>`;
    }
...
function cycleStatus(cad) {
    if (!currentApprover) { alert("Digite o nome de quem está aprovando no topo da tela!"); return; }
...
function approveBranch(branchName) {
    ...
    if (!confirm(`Aprovar TODOS da filial ${branchName} no setor ${currentSector.toUpperCase()}?`)) return;
...
function approveAllDaily() {
    if (!currentApprover) { alert("Digite seu nome no topo!"); return; }
    if (!confirm(`Aprovar TODOS os motoristas (${currentSector.toUpperCase()}) para o dia ${currentDateKey}?`)) return;
    const timeNow = new Date().toLocaleTimeString('pt-BR');
    const updates = {};
    driverList.forEach(d => {
        const tipo = d.t || 'rodoviario';
...
function reproveAllDaily() {
    if (!currentApprover) { alert("Digite seu nome no topo!"); return; }
    if (!confirm(`REPROVAR TODOS os motoristas (${currentSector.toUpperCase()}) para o dia ${currentDateKey}?`)) return;
    const timeNow = new Date().toLocaleTimeString('pt-BR');
    const updates = {};
    driverList.forEach(d => {
        const tipo = d.t || 'rodoviario';
...
function cancelAllDaily() {
    if (!confirm(`Isso vai LIMPAR as aprovações de HOJE para o setor ${currentSector.toUpperCase()}.\nConfirmar?`)) return;
    const updates = {};
    driverList.forEach(d => {
        const tipo = d.t || 'rodoviario';
...
function removeDriver(cad) {
    if (!confirm("Tem certeza que deseja remover este colaborador da base?")) return;
...
function renderManageList() {
    ...
    driverList.forEach(d => {
        const tipoTag = d.t === 'fretamento' ? '<span style="background:#FBAF17; color:#000; padding:2px 5px; border-radius:4px; font-size:10px; margin-left:5px;">Fretamento</span>' : '<span style="background:#006B3F; color:#fff; padding:2px 5px; border-radius:4px; font-size:10px; margin-left:5px;">Rodoviário</span>';
        const item = document.createElement('div');
        item.className = 'manage-item';
        item.innerHTML = `<span><b style="color:var(--brand)">${d.b}</b> - ${d.n} <small style="color:#888">(CAD: ${d.c})</small> ${tipoTag}</span> <button class="btn-del" onclick="removeDriver('${d.c}')"><i class="fas fa-trash"></i></button>`;
        listContainer.appendChild(item);
    });
}

// --- BUSCA E AÇÃO INDIVIDUAL (NOVO PAINEL) ---
function searchDriver() {
    ...
    if (found) {
        ...
        resDiv.innerHTML = `<i class="fas fa-check-circle"></i> <b>Encontrado:</b><br><span style="font-size: 18px; font-weight:bold;">${found.n}</span><br>Filial: ${found.b} | CAD: ${found.c} | Setor: ${tipoStr}`;
    } else {
        selectedIndivCad = "";
...
function applyIndividualAction(statusType) {
    ...
    if (!selectedIndivCad) { alert("Por favor, BUSQUE e encontre um colaborador válido primeiro."); return; }

    const startVal = document.getElementById('indivStartDate').value;
    const endVal = document.getElementById('indivEndDate').value;

    if(!startVal || !endVal) { alert("Preencha a Data Inicial e Final!"); return; }
    ...
    let actionName = statusType === 'OK' ? "APROVAR" : (statusType === 'Erro' ? "REPROVAR" : "CANCELAR / LIMPAR");
    if(!confirm(`Ação: ${actionName} no período.\nConfirmar operação para este colaborador?`)) return;
    ...
    database.ref().update(updates)
        .then(() => alert(`Ação ${actionName} aplicada com Sucesso para o período selecionado!`))
